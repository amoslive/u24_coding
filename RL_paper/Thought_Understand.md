...
>
>在策略梯度里，𝜋𝜃(𝑎∣𝑠)表示在状态𝑠下选择动作𝑎的概率。因此，∇𝜃𝜋𝜃(𝑎∣𝑠) 或 ∇𝜃log𝜋𝜃(𝑎∣𝑠)表示：如果想改变这个动作被选中的倾向，参数该怎么调。
>
>这版就很准了。

>从 control law 角度再翻译一遍
>
其实它等价于：
>
>>如果某次控制输出效果很好，那以后在类似状态下，控制器更倾向于输出类似动作。
>
>只不过 RL 用“概率增大”来表达这个“更倾向于”。
